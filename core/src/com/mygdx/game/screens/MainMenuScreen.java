    ...
    public MainMenuScreen(BludBourne game) {
        ...
        newGameButton.addListener(new ClickListener() {
                                      ...
                                      public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                                          _game.setScreen(_game.getScreenType(BludBourne.ScreenType.NewGame));
                                      }
                                  }
        );
        ...
        watchIntroButton.addListener(new ClickListener() {
                                         ...
                                         public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                                             ...
                                             _game.setScreen(_game.getScreenType(BludBourne.ScreenType.WatchIntro));
                                         }
                                     }
        );
        ...
        creditsButton.addListener(new ClickListener() {
                                      ...
                                      @Override
                                      public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                                          _game.setScreen(_game.getScreenType(BludBourne.ScreenType.Credits));
                                      }
                                  }
        );
